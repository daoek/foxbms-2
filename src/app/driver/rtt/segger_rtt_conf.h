 ...
 * @prefix  SEGGER
 *
 * @brief   SEGGER RTT configuration
 * @details Configuration options for SEGGER real-time transfer buffers and locking.
 */

#ifndef FOXBMS__SEGGER_RTT_CONF_H_
#define FOXBMS__SEGGER_RTT_CONF_H_
...
#endif /* FOXBMS__SEGGER_RTT_CONF_H_ */
/*************************** End of file ****************************/
