 ...
 * @prefix  SEGGER
 *
 * @brief   SEGGER RTT public API
 * @details Interface for SEGGER real-time transfer debug communication.
 */

#ifndef FOXBMS__SEGGER_RTT_H_
#define FOXBMS__SEGGER_RTT_H_
...
#define RTT__DMB()                asm VOLATILE("DMB");
    ...
    ((defined __ARM8A__) && (__CORE__ == __ARM8A__)) || ((defined __ARM8R__) && (__CORE__ == __ARM8R__))
/* */
/* Cortex-A/R ARMv7-A/R & ARMv8-A/R */
/* */
#define _CORE_NEEDS_DMB 1
